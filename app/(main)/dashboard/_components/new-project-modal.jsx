        ...
        <DialogContent>
          ...
          <div className="space-y-6">
              ...
              <Alert className="bg-border-500/10 border-amber-500/20">
                ...
                <AlertDescription className="text-amber-300/80">
                  <div className="font-semibold text-amber-400 mb-1">
                    ...
                    {currentProjectCount === 2
                      ? "This will be your last free project.Upgrade to Chromatic Canvas Pro for unlimited projects"
                      : "Free Plan is limited to 3 projects.Upgrade to Chromatic Canvas Pro to create more projects."}
                  </div>
                </AlertDescription>
              </Alert>
            )}
            ...
            {!selectedFile ? (
              <div
                {...getRootProps()}
                className={`border-2 border-dashed rounded-xl p-12 text-center cursor-pointer transition-all ${isDragActive ? "border-cyan-400 bg-cyan-400/50" : "border-white/20 hover:border-white/40"} ${!canCreate ? "opacity-50 pointer-events-none" : ""}`}
              >
                <input {...getInputProps()} />
