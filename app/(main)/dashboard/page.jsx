        ...
        <div className='container mx-auto px-6'>
            <div className='flex items-center justify-between mb-8'>
                <div>
                    ...
                    <p className='text-white/70'>Create and manage AI-powered image designs</p>
                </div>
            ...
            {isLoading?(
                ...
                projects && projects.length>0?<></>:(<div className='flex flex-col items-center justify-center py-20 text-center'>
